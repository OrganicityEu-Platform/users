  ...
  render() {
    return (
      ...
      <% if (user.twitter.token) { %>
          ...
          <a href="/api/v1/users/<%=user.uuid %>/unlink/twitter" className="btn btn-info top10">Unlink</a>
      <% } else if(req_user.uuid == user.uuid) { %>
          <a href="/api/v1/auth/connect/twitter" className="btn btn-info">Connect Twitter</a>
      <% } %>
    );
  }
}
